...
const categories = [
  ...
  { name: "Wellness", image: "https://via.placeholder.com/150", price: "$35", rating: 4.9 },
  { name: "Organic Beauty", image: "https://via.placeholder.com/150", price: "$24", rating: 4.5 },
  { name: "Luxury Beauty", image: "https://via.placeholder.com/150", price: "$50", rating: 4.8 },
  { name: "Korean Beauty", image: "https://via.placeholder.com/150", price: "$27", rating: 4.6 },
  { name: "Japanese Beauty", image: "https://via.placeholder.com/150", price: "$26", rating: 4.5 },
  { name: "Vegan Beauty", image: "https://via.placeholder.com/150", price: "$23", rating: 4.3 },
  { name: "Ayurvedic Beauty", image: "https://via.placeholder.com/150", price: "$21", rating: 4.2 },
  { name: "Sensitive Skin", image: "https://via.placeholder.com/150", price: "$29", rating: 4.7 },
  { name: "Anti-Aging", image: "https://via.placeholder.com/150", price: "$40", rating: 4.9 },
  { name: "Budget Beauty", image: "https://via.placeholder.com/150", price: "$10", rating: 4.0 },
];
